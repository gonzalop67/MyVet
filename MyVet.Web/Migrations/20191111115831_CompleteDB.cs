        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(nullable: false),
                    Remarks = table.Column<string>(nullable: true),
                    GetServiceTypeId = table.Column<int>(nullable: true),
                    PetId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Histories_ServiceTypes_GetServiceTypeId",
                        column: x => x.GetServiceTypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histories_GetServiceTypeId",
                table: "Histories",
                column: "GetServiceTypeId");
